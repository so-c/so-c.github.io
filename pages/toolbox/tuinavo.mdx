...
超会議クラウドファンディングのニコ動公認☆ついなちゃん特典ボイスは、zipではなくwavが配布されています。そのためzipフォルダではなくwavフォルダに「【超会議CF】ニコ動公認☆ついなちゃん特典ボイス」フォルダを作成し、その中に保存してください。
</Callout>
