...
VOICEVOX, COEIRINK(v1)にはvoivocaを、COEIROINK(v2)にはcoeicaを利用してください

<Callout type="warning" emoji="⚠️">
coeicaはMYCOEIROINKに対応していますが、voivocaは未対応です。また今のところ対応予定はありません。要望あればお寄せください（プルリクエストで実装を送ってもらえるとなお嬉しいです）
</Callout>
